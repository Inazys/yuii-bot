...
module.exports = {
    name: 'slap',
    aliases: ['batslap'],
    utilisation: '{prefix}slap <someone>',
    category: 'image',

    async execute(client, message) {
        const you =  message.author
        const user = message.mentions.users.first() || message.author
        const buffer = await ameAPI.generate("batslap", { url: you.displayAvatarURL({ format: "png", size: 512 }), avatar: user.displayAvatarURL({ format: "png", size: 512 })});
